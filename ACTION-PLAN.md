...
1. **9 orphan page(s) with zero inbound internal links.**
   - Priority: `Critical`
   - Area: `link_profile`
...
5. **2 page(s) with no outbound internal links (dead ends).**
   - Priority: `Warning`
   - Area: `link_profile`
   - Evidence: See audit output.
   - Fix: Add contextual internal links to related content from these pages.
6. **No Wikidata entry found for 'Hoducation Technologies Pvt Ltd'.**
   - Priority: `Info`
   - Area: `Wikidata`
   - Evidence: See audit output.
...
7. **No Wikipedia article found for 'Hoducation Technologies Pvt Ltd'.**
   - Priority: `Info`
   - Area: `Wikipedia`
   - Evidence: See audit output.
